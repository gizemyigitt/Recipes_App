...
namespace WebSite.Controllers
{
    public class MalzemeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Ad,Miktar,Birim")] Malzeme malzeme)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ad,Miktar,Birim")] Malzeme malzeme)
        {
            if (id != malzeme.Id)
            {
                return NotFound();
